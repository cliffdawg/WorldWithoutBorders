...
// MARK: Segue class
/* Will use the .SwipeDown animation to transition to the school view if needed */
class CustomSegue2: UIStoryboardSegue {
    
    var animationType = CustomSegue2Animation.SwipeDown
